...
-- Volcando datos para la tabla database.Pedido: ~2 rows (aproximadamente)
...
-- Volcando datos para la tabla database.ProdPedido: ~6 rows (aproximadamente)
...
INSERT INTO `Producto` (`id_producto`, `nombre`, `precio`, `descripcion`, `procedencia`, `foto`) VALUES
	...
	(5, 'Fresa', 5, 'Fruta que se obtiene del fresal', 0, NULL);
